...
qemu-system-aarch64 \
    ...
    -device loader,file=/home/c/w/qemu_xen_testing/xen-uImage,force-raw=on,addr=0x49000000 \
    -device loader,file=/home/c/w/qemu_xen_testing/virt-gicv3_chosen.dtb,force-raw=on,addr=0x44000000 \
    -device loader,file=/home/c/w/qemu_xen_testing/Image2,force-raw=on,addr=0x4a000000 \
    -device loader,file=/home/c/w/qemu_xen_testing/uramdisk.img,force-raw=on,addr=0x4b000000 \
    -monitor none \
    -nographic \
    -serial mon:stdio \
